...
begin
  ...
  -- N'insère que nom/adresse/cp/ville : beaucoup de bases n'ont pas latitude/longitude sur laveries.
...
-- 8) Lien CRM à la demande (fiche emplacement, évite "aucune laverie liée" si le match nom/adresse échoue)
