-- RPC create_transaction_and_start_machine : ne passe PAS la machine en occupe ici.
-- Le statut occupe + estimated_end_time sont posés uniquement par set_transaction_duration
-- (sinon les machines restent occupe sans date → jamais libérées par release_expired_machines).
-- Exécuter dans Supabase → SQL Editor
-- IMPORTANT : exécuter d'abord supabase-add-statut-machines.sql si la colonne statut n'existe pas
